    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          {' '}— the curated discount platform for students. Click below to accept and create your account.
        </Text>
...
const logoSection = { marginBottom: '12px' }
const logo = { borderRadius: '12px', display: 'block' }
const brand = { fontSize: '18px', fontWeight: 'bold' as const, color: 'hsl(220, 20%, 10%)', margin: '0 0 24px', letterSpacing: '-0.01em' }
const h1 = {
  fontSize: '24px',
