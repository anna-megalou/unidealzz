  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          We received a request to reset the password for your Unidealz account. Click the
        ...
        <Text style={fallbackText}>Or copy and paste this link into your browser:</Text>
