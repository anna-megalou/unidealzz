...
const FavoriteBrandNewOfferEmail = ({ name, offers = [] }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>New deals from your favorite brands on {SITE_NAME}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Brands you&apos;ve saved to your favorites just launched fresh student discounts.
        ...
        {offers.map((o, i) => (
          <Section key={i} style={card}>
            ...
            {o.discountLabel ? <Text style={discount}>{o.discountLabel}</Text> : null}
...
const hr = { border: 'none', borderTop: '1px solid hsl(220, 10%, 92%)', margin: '24px 0' };
const footer = { fontSize: '13px', color: 'hsl(220, 10%, 55%)', margin: '28px 0 0' };
