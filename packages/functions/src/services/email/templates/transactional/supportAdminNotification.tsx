...
const SupportAdminNotificationEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>New support ticket{subject ? `: ${subject}` : ''}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>New support ticket</Heading>
        <Text style={text}>A new ticket has been submitted on {SITE_NAME}.</Text>
        <Section style={card}>
        ...
        <Text style={footer}>Manage tickets in the Operations portal → Support.</Text>
      </Container>
    </Body>
  </Html>
);
...
export const template: TemplateEntry = {
  ...
  subject: (data) => `[Support] ${data?.subject ?? 'New ticket'}`,
