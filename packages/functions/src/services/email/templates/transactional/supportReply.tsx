  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          If you have any follow-up questions, just reply to this email and we&apos;ll get back
          to you.
        </Text>
        ...
        {originalSubject || originalMessage ? (
          <Section style={quoteCard}>
            ...
            {originalSubject ? <Text style={quoteSubject}>{originalSubject}</Text> : null}
            {originalMessage ? <Text style={quoteBody}>{originalMessage}</Text> : null}
          </Section>
        ) : null}
      </Container>
    </Body>
...
export const template: TemplateEntry = {
  ...
  subject: (data) =>
    data?.originalSubject ? `Re: ${data.originalSubject}` : 'Reply from Unidealz support',
  ...
  previewData: {
    ...
    replyMessage:
      "Hi Alex,\n\nThanks for reaching out! Please try resubmitting your student email from your account page.",
  },
};
...
const footer = { fontSize: '13px', color: 'hsl(220, 10%, 55%)', margin: '24px 0 0' };
const quoteCard = {
